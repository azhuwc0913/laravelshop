@extends('resources.views.layouts.home')
		
@section('header')
@parent
@include('resources.views.layouts.header')
@endsection
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						<dt>价格：</dt>
						<dd class=" @if(!isset($get['price']))cur @endif"><a href="{{FilterManager::url('price', FM_SELECT_ALL)}}">不限</a></dd>
						@foreach($searchData['price'] as $k=>$v)
						<dd class=" @if(($get['price']==$v)) cur @endif"><a href="{{ FilterManager::url('price',$v) }}">{{ $v }}</a></dd>
						@endforeach
					</dl>
					...
					<dl>
						...
						<dd class=" @if(!isset($get['attr_'.$k1])) cur @endif"><a href="{{FilterManager::url('attr_'.$v1[0]->attr_id, FM_SELECT_ALL)}}">不限</a></dd>
						@foreach($v1 as $k2=>$v2)
						<dd class=" @if(isset($get['attr_'.$v2->attr_id]) && ($get['attr_'.$v2->attr_id]==$v2->attr_value.'-'.$v2->attr_name)) cur @endif"><a href="{{ FilterManager::url('attr_'.$v2->attr_id,$v2->attr_value.'-'.$v2->attr_name) }}">{{ $v2->attr_value }}</a></dd>
						@endforeach
					</dl>
					@endforeach
			...
			<div class="page mt20">
				...
				{!! $GoodsData->appends(['sort'=>$sort])->links() !!}
			</div>
			<!-- 分页信息 end -->
